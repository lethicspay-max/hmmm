        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link to="/forgot-password?type=corporate" className="text-red-600 hover:text-red-500">
            ...
            <div className="text-center">
              <span className="text-sm text-gray-600">
                ...
                <Link to="/corporate/register" className="text-red-600 hover:text-red-500 font-medium">
                  Sign up here
                </Link>
              </span>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Link
                to="/"
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-500 bg-white hover:bg-gray-50 col-span-2"
              >
                Back to Home
              </Link>
            </div>
